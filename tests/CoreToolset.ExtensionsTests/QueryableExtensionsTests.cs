...
namespace CoreToolset.ExtensionsTests
{
    ...
    public class QueryableExtensionsTests
    {
        ...
        #region ToPaginateAsync Tests
        [Test]
        public void ToPaginateAsync_WithNegativeIndex_ThrowsArgumentException()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = -1;
            int size = 10;
            ...
            Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () =>
                await source.ToPaginateAsync(index, size, -2));
        }

        [Test]
        public void ToPaginateAsync_WithNegativeSize_ThrowsArgumentException()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = -10;
            ...
            Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () =>
                await source.ToPaginateAsync(index, size));
        }

        [Test]
        public void ToPaginateAsync_WithNegativeFrom_ThrowsArgumentException()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = 10;
            ...
            Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () =>
                await source.ToPaginateAsync(index, size, from));
        }

        [Test]
        public void ToPaginateAsync_WithFromGreaterThanIndex_ThrowsArgumentException()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = 10;
        ...
        [Test]
        public async Task ToPaginateAsync_WithZeroSize_ReturnsEmptyEnumerable()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = 0;

            var result = await source.ToPaginateAsync(index, size);
            Assert.That(result.Items, Is.Empty);
        }

        [Test]
        public async Task ToPaginateAsync_TotalCountCalculatedCorrectly()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = 10;
        ...
        [Test]
        public async Task ToPaginateAsync_ItemsCountCalculatedCorrectly()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = 10;
        ...
        [Test]
        public async Task ToPaginateAsync_PagesCalculatedCorrectly()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = 10;
        ...
        [Test]
        public async Task ToPaginateAsync_WithEmptySource_ReturnsPaginateObjectWithZeroCount()
        {
            IQueryable<int> source = Enumerable.Empty<int>().AsQueryable();
            int index = 2;
            int size = 10;
        ...
        [Test]
        public async Task ToPaginateAsync_WithValidParameters_ReturnsPaginateObject()
        {
            IQueryable<int> source = Enumerable.Range(1, 100).AsQueryable();
            int index = 2;
            int size = 10;
            ...
            var result = await source.ToPaginateAsync(index, size, from);
        ...
        [Test]
        public async Task ToPaginateAsync_PerformanceTest()
        {
            IQueryable<int> source = Enumerable.Range(1, int.MaxValue - 56).AsQueryable();
            int index = 500000;
            int size = 100;
            ...
            var (averageTime, maxTime) = await PerformanceTestHelper.RunPerformanceTestAsync(async () =>
            {
                var result = await source.ToPaginateAsync(index, size);
            }, numberOfRuns);
